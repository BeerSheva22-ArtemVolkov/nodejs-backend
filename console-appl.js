...
console.log("\nexample of asynchronous console input"); // что-то идет параллельно
...
async function asyncTyping() {
    ...
    if (num1) {
        ...
        console.log(`num1=${num1}, num2=${num2}, num3=${num3}, appleOrange=${appleOrange}, employee=${JSON.stringify(employee)}`);
    }
